        ...
        <Reveal>
          ...
          <div className="lg:col-span-2">
            ...
            <a
              ...
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-gold px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-gold-dark"
            >
          ...
          >
            ...
            <button
              type="submit"
              className="mt-8 w-full rounded-full bg-charcoal px-8 py-3.5 text-sm font-semibold text-cream transition-all duration-300 hover:scale-[1.02] hover:bg-gold"
            >
              Enviar consulta
            </button>
          </form>
